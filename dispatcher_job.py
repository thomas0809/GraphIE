...
parser.add_argument('--task', type=str, default='job')
...
if __name__ == "__main__":
    model_args = {
            'model'         : ['lstm-lstm', 'lstm-gcn-lstm', 'lstm-gat-lstm'], # 'lstm-gcn-lstm', 'lstm-lstm', 'lstm', 
    ...
    for cur_args in all_args_dict:
        # if cur_args['crf'] == True and cur_args['weight_balance'] != 1.5:
        #     continue
